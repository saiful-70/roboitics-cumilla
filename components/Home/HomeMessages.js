...
const homeMessageContent = {
  msg1: {
    ...
    job: "জেলা প্রশাসক ও বিজ্ঞ জেলা ম্যাজিস্ট্রেট, কুমিল্লা",
    message:
  ...
  msg2: {
    ...
    message:
      "আমাদের তরুনরা আজকাল মুঠোফোনের দিকেই বেশি ঝুকে পড়ছে। এই প্রোগ্রামিইং বিষয়টার সবথেকে মজার ব্যাপার হচ্ছে একটা স্মার্ট ফোন দিয়েও যেকেউ চাইলেই প্রোগ্রামিং করতে পারবে। ছোটদের এই মুঠোফোনের প্রতি আকর্শনকেই আমরা কাজে লাগাতে পারি তাদের প্রোগ্রামিং চর্চার হাতেখড়ি হিসেবে। আমার মনে হয় দেশের প্রায় সকল জেলার শিক্ষার্থীদের মাঝে কোন কিছু শেখার প্রতিযগিতামূলক একটা আগ্রহ ছড়িয়ে দিতে পাড়াটাই আসলে অনেক বড় অর্জন। ২০৪১ সালের মধ্যে উন্নত জ্ঞ্যান ভিত্তিক সমাজে উন্নীত হওয়ার বাংলাদেশের একটি লক্ষ্য রয়েছে। এসব আয়োজনের মাধ্যমে আগ্রগতির এই ধারা এভাবেই বজায় থাকলে খুব শীগ্রহী সেই লক্ষ্য পূরন করা সম্ভব।",
  },
};
