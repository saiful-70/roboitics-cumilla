...
const homeCardContent = {
  card1: {
    ...
    content: [
      "মুজিব শতবর্ষ ও বাংলাদেশের সূবর্ণ জয়ন্তী উপলক্ষে কুমিল্লা জেলা প্রসাশক কর্তৃক আয়োজিত রোবোটিক্স ও প্রোগ্রামিং কোর্স।",
    ],
  },
  card2: {
  ...
  card3: {
    ...
    content: [
      ...
      "৫। লাইন ফলোয়ার রোবট",
      "৬। মোবাইন কন্ট্রোল রোবট",
      "৭। প্রোগ্রামিং এর মজার জগত সম্পর্কে জানবো",
      "৮। জাতীয় প্রতিযোগিতার জন্য নিজেদের প্রস্তত করবো",
    ],
  },
};
