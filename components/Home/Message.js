...
const homeMessageContent = {
  msg1: {
    ...
    message:
      "চতুর্থ শিল্প বিপ্লবের পথে বাংলাদেশ এগিয়ে যাচ্ছে। এখানে নেতৃত্ব দেওয়ার মতো সক্ষমতা আমাদের আছে। আর তাই আর্টিফিশিয়াল ইন্টেলিজেন্স, ব্লক চেইন, আইওটি, ন্যানো টেকনোলজি, বায়োটেকনোলজি, রোবটিকস, মাইক্রোপ্রসেসর ডিজাইনের মত ক্ষেত্রগুলোতে জোর দিচ্ছি আমরা। এক সাথে উদ্ভাবনের পথে একযোগে কাজ করতে হবে, তাহলেই আমরা এগিয়ে যাব। দেশে তথ্যপ্রযুক্তিখাতে বিনিয়োগ বাড়ানর জন্য আমরা বিশ্বমানের ৩৯টি হাই টেক পার্ক নির্মাণ করেছি। ২০২৫ সালে মধ্যে ৫ বিলিয়ন ডলারের আইটি পণ্য রপ্তানির লক্ষ্যমাত্রা নিয়ে কাজ করছি আমরা।",
  },
  msg2: {
    image: zunayedAhmed,
  ...
  msg3: {
    ...
    message:
      "প্রিয় শিক্ষার্থীরা, বিশ্বব্যাপী তথ্য ও যোগাযোগ প্রযুক্তির ব্যবহার এবং এর প্রয়োগ জ্যামিতিক হারে বেড়ে চলেছে। উন্নত বাংলাদেশ বিনির্মাণে ২০৪১ সালের মধ্যে তথ্যপ্রযুক্তিনির্ভর দক্ষ মানবসম্পদ সৃষ্টির গুরুত্ব অনস্বীকার্য। এ উদ্দেশ্যে জেলা প্রশাসকের কার্যালয়ের মাধ্যমে বিভিন্ন ধাপে প্রোগ্রামিংয়ের উপর ধারণা প্রদান করার উদ্যোগে প্রশিক্ষণ কর্মসূচি চলমান রয়েছে। এ প্রশিক্ষণের মাধ্যমে তোমরা বেসিক প্রোগ্রামিং, অরড্যুইনো প্রোগ্রামিং, ফান উইথ প্রোগ্রামিং, ইলেক্টনিক্সসহ নানামুখি শিক্ষা অর্জন করতে পারবে। তাছাড়া প্রশিক্ষণলব্ধ জ্ঞান ব্যবহারিক ক্ষেত্রে প্রয়োগ করার সুযোগ প্রদানের লক্ষ্যে জেলা প্রশাসকের কার্যালয়ে স্থাপন করা হচ্ছে কালেক্টরেট ফ্যাবল্যাব। আমাদের খুদে শিক্ষার্থীদের জন্য যে প্ল্যাটফর্ম আমরা তৈরি করছি তা একদিন ডিজিটাল বাংলাদেশ গড়ার ভিত্তি আরও সুদৃঢ় করবে।",
  },
};
    ...
    <div className="mx-auto mt-16 w-full">
      ...
      <div className="md:flex md:justify-between">
        {Object.keys(homeMessageContent).map((item) => (
          <div
            key={item}
            className="my-8 mx-5 flex h-max flex-col items-center justify-center border-2 bg-gray-100 py-5 shadow-md shadow-blue-500 md:mx-auto md:w-2/3 lg:mx-1 lg:w-1/3"
          >
